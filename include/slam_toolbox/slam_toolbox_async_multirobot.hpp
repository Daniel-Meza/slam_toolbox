...
class AsynchronousMultiRobotSlamToolbox : public SlamToolbox
{
  public:
    explicit AsynchronousMultiRobotSlamToolbox(rclcpp::NodeOptions options);
    ~AsynchronousMultiRobotSlamToolbox() {}
  ...
  protected:
    ...
    bool deserializePoseGraphCallback(
      ...
      const std::shared_ptr<slam_toolbox::srv::DeserializePoseGraph::Request> req, std::shared_ptr<slam_toolbox::srv::DeserializePoseGraph::Response> resp) override;
